...
public class MyReservations extends javax.swing.JFrame {
    ...
    private void loadData() {
                User currentUser = VillaLibraryMS.SessionData.currentUser;
        ResultSet rs = MiscRepository.myReservations(currentUser.getId());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jTable1.getSelectionModel().isSelectionEmpty()) {
            ...
            MiscRepository.cancelReservation(selectedId);
            loadData();
        }

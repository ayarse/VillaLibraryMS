...
public class ViewFines extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!jTable1.getSelectionModel().isSelectionEmpty()) {
            Integer selectedFine = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
            MiscRepository.settleFine(selectedFine);
            loadData();
        }
    ...
    private void loadData() {
        ...
        jTable1.setModel(DbUtils.resultSetToTableModel(MiscRepository.getAllFines(searchStr)));
    }
